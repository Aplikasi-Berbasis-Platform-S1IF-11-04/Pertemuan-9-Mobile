...
class PraktikumApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: '2311102267 - Ghilbran Alfaries Pryma',
      theme: ThemeData(
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Menambahkan NIM dan Nama di AppBar
        title: const Text('2311102267 - Ghilbran Alfaries Pryma', style: TextStyle(fontSize: 18)),
        centerTitle: true,
      ),
  ...
  // --- Mulai dari sini adalah perubahan struktur (Ekstraksi Widget) ---
  ...
  Widget _buildContainerView() {
    return Container(
      ...
      child: const Text(
        // Mengisi teks kosong dengan Nama
    ...
    return Center(
      child: Stack(
        ...
        children: [
          ...
          const Text(
            // Mengubah teks Stack menjadi NIM
            '2311102267', 
            style: TextStyle(
              fontSize: 22,
              fontWeight: FontWeight.bold,
